...
export class Backend implements backendInterface {
    ...
    async calculatePayout(arg0: bigint, arg1: bigint): Promise<{
        tourDays: bigint;
        grossSalary: number;
        workingDays: bigint;
        sundayOvertimes: bigint;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.calculatePayout(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMonthAttendance(arg0: bigint, arg1: bigint): Promise<Array<[bigint, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthAttendance(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSalary(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getSalary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeAttendance(arg0: bigint, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeAttendance(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setAttendance(arg0: bigint, arg1: bigint, arg2: bigint, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAttendance(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setSalary(arg0: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setSalary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
